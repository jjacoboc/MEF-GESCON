...
public class BuenaPracticaMB implements Serializable{
    ...
    public void saveOrUpdateDiscusion(ActionEvent event) {
        ...
        try {
            ...
            discusionHist.setNconocimientoid(this.getSelectedBuenaPractica().getNconocimientoid());
    ...
    public void toCompare(ActionEvent event){
        try {
            if (event != null) {
                ...
                FacesContext.getCurrentInstance().getExternalContext().redirect("/gescon/pages/buenapractica/historialCompare.xhtml");
            }
        } catch (Exception e) {
            e.getMessage();
            e.printStackTrace();
    ...
    public void switchHistory(ActionEvent event) {
        try {
            ...
            this.getSelectedBuenaPractica().setVdescripcion(hist.getVdescripcion());
            this.getSelectedBuenaPractica().setVmsjrespuesta(hist.getVmsjrespuesta());
            this.getSelectedBuenaPractica().setVmsjsolicita(hist.getVmsjsolicita());
            this.getSelectedBuenaPractica().setVnumero(hist.getVnumero());
            this.getSelectedBuenaPractica().setVobservacion(hist.getVobservacion());
            this.getSelectedBuenaPractica().setVtema(hist.getVtema());
    ...
    public void addCalificacion(ActionEvent event) {
        try {
            ...
            cal.setNconocimientoid(this.getSelectedBuenaPractica().getNconocimientoid());
            ...
            this.setListaCalificacion(calificacionService.getCalificacionesByConocimiento(this.getSelectedBuenaPractica().getNconocimientoid()));
